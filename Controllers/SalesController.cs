...
namespace Onboarding_Task.Controllers
{
    ...
    {
        private readonly MVP_Task1Context _context;

        public SalesController(MVP_Task1Context context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Sales.Include(s => s.Product).Include(s=> s.Customer).Include(s=> s.Store).ToListAsync();
        }
